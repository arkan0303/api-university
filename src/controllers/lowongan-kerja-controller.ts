import lowonganKerjaService from "../services/lowongan-kerja-service";
...
class LowonganKerjaController {
  async createLowonganKerja(req: MulterRequest, res: Response) {
    try {
      const {
        foto,
        title,
        perusahaan,
        lokasi,
        tipePekerjaan, // Full Time, Part Time
        gaji,
        pengalaman,
        pendidikan,
        batasLama,
      ...
      const create = await lowonganKerjaService.createLowonganKerja({
  ...
  async getAllLowonganKerja(req: Request, res: Response) {
    try {
      const getAllLowonganKerja =
        await lowonganKerjaService.getAllLowonganKerja();
  ...
  async updateLowonganKerja(req: MulterRequest, res: Response) {
    try {
      const { id } = req.params;
      const {
        foto,
      ...
      const updatedLowonganKerja =
        await lowonganKerjaService.updateLowonganKerja(
  ...
  async deleteLowonganKerja(req: Request, res: Response) {
    try {
      const result = await lowonganKerjaService.deleteLowonganKerja(
  ...
  async createStatistikLowonganKerja(req: Request, res: Response) {
    try {
      const {
        lowonganAktif,
        partner,
      ...
      const create = await lowonganKerjaService.createStatistikLowonganKerja({
        lowonganAktif,
        partner,
        tingkatPenempatan,
        gajihRata,
  ...
  async getAllStatistikLowonganKerja(req: Request, res: Response) {
    try {
      const getAllStatistikLowonganKerja =
        await lowonganKerjaService.getAllStatistikLowonganKerja();
      return res.status(200).json({
        success: true,
  ...
  async updateStatistikLowonganKerja(req: Request, res: Response) {
    try {
      const { id } = req.params;
      const {
        lowonganAktif,
      ...
      const updatedStatistikLowonganKerja =
        await lowonganKerjaService.updateStatistikLowonganKerja(
          Number(id), // Konversi id ke number
          updateData
        );
      return res.status(200).json({
  ...
  async deleteStatistikLowonganKerja(req: Request, res: Response) {
    try {
      const result = await lowonganKerjaService.deleteStatistikLowonganKerja(
        Number(req.params.id)
      );
      return res.status(200).json({
        success: true,
...
export default new LowonganKerjaController();
