import trackerStudyService from "../services/tracker-study-service";
...
class TrackerStudyController {
  async createTrackerStudy(req: MulterRequest, res: Response) {
    try {
  ...
  async getAllTrackerStudy(req: Request, res: Response) {
    try {
  ...
  async updateTrackerStudy(req: MulterRequest, res: Response) {
    try {
      const { id } = req.params;
      const { title, tugas, gajihRata, persentasi, institusi, keahlian } =
        req.body;
  ...
  async deleteTrackerStudy(req: Request, res: Response) {
    try {
      const { id } = req.params;
  ...
  async updateWaktuTungguKerja(req: Request, res: Response) {
    try {
      const { id } = req.params;
      const { kategoriWaktu, persentasi, deskripsi } = req.body;
      const updateData: any = {
  ...
  async deleteWaktuTungguKerja(req: Request, res: Response) {
    try {
      const { id } = req.params;
  ...
  async createStatistikTrackerStudy(req: Request, res: Response) {
    try {
      const {
        tingkatKeterserapan,
        rataGaji,
  ...
  async getAllStatistikTrackerStudy(req: Request, res: Response) {
    try {
      const statistikTrackerStudy =
  ...
  async updateStatistikTrackerStudy(req: Request, res: Response) {
    try {
      const { id } = req.params;
      const {
        tingkatKeterserapan,
  ...
  async deleteStatistikTrackerStudy(req: Request, res: Response) {
    try {
      const { id } = req.params;
...
export default new TrackerStudyController();
