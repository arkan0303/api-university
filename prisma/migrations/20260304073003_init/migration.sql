...
CREATE TABLE `programsarjanahukum` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `mata_kuliah` VARCHAR(191) NULL,
    `semester` VARCHAR(191) NULL,
    `kode_matkul` VARCHAR(191) NULL,
    `bobot` VARCHAR(191) NULL,
    `dokumen_rps` VARCHAR(191) NULL,
...
CREATE TABLE `daftardosen` (
    ...
    `tahun_publikasi` VARCHAR(191) NULL,
    `ahli` VARCHAR(191) NULL,
    `jabatan_akademik` VARCHAR(191) NULL,
    `link_sinta` VARCHAR(191) NULL,
    `link_ppdikti` VARCHAR(191) NULL,
    `urutan` VARCHAR(191) NULL,
    `jabatan_struktural` VARCHAR(191) NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
